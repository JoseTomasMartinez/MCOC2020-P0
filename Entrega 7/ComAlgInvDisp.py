...
Corridas=10
N = [2,5,10,12,15,20,30,40,45,50,55,60,75,100,125,160,200,250,350,500,600,800,1000,3000,5000,10000]
ENcorridas=[]
ALcorridas=[]
...
plt.title("Complejidad algoritmica inversa Dispersa")
...
plt.legend()
plt.savefig("Complejidad algoritmica inversa Dispersa")	
plt.show()